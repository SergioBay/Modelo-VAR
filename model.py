...
# - Series no estacionarias pueden generar regresiones espurias.  
# =============================================================================
...
# - Integración de orden 1 (I(1)) convierte series no estacionarias en estacionarias.  
# =============================================================================
...
# - VAR modela cada variable como función de sus propios rezagos y los de otras variables.  
# =============================================================================
model = VAR(df_diff)  
...
# - Útil para entender dinámicas de corto/largo plazo entre variables.  
# =============================================================================
irf = results.irf(10)  
irf.plot(orth=False)  
...
# - Si "X Granger-causa Y", los rezagos de X mejoran la predicción de Y.  
# =============================================================================
